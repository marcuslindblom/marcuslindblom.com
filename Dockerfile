FROM mcr.microsoft.com/dotnet/aspnet:8.0-preview-alpine3.17 AS base
WORKDIR /app
EXPOSE 80
EXPOSE 443
...
ENV DEPLOYMENT_IDENTIFIER=$RAILWAY_GIT_COMMIT_SHA
